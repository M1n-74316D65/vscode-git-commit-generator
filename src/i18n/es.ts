...
- Referencia cambios importantes (breaking changes) si los hay`,
  ...
  messages: {
    ...
    generated: 'Mensaje de commit:',
    error: 'No se puede generar el mensaje de commit: {0}',
    gitUnavailable: 'Git no está en el PATH del sistema. Algunas funciones de la extensión no funcionarán.',
    openSettings: 'Abrir configuración',
    welcomeReady: 'Git Commit Generator está listo. Selecciona el botón de brillo en Source Control para generar un mensaje.',
    ...
    diffTooLarge: 'El diff es grande. La extensión lo truncará para ajustarlo al contexto del modelo.',
    styleChanged: 'Estilo de commit: {0}',
    ...
    modelSet: 'Modelo seleccionado: {0} ({1})',
    refreshingModels: 'Actualizando modelos de lenguaje disponibles.',
    modelsFoundOpeningSelector: 'Se encontraron {0} modelos disponibles. Abriendo la lista de modelos.',
    errorFetchingModels: 'No se pueden obtener los modelos de lenguaje: {0}',
    errorRefreshingModels: 'No se pueden actualizar los modelos de lenguaje: {0}',
    ...
    activationFailed: 'Git Commit Generator no se inició. Revisa la consola de depuración.',
