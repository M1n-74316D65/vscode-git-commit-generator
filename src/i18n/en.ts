...
- Reference breaking changes if any`,
  ...
  messages: {
    ...
    error: 'Cannot generate the commit message: {0}',
    gitUnavailable: 'Git is not in the system PATH. Some extension features will not work.',
    openSettings: 'Open Settings',
    welcomeReady: 'Git Commit Generator is ready. Select the sparkle button in Source Control to generate a message.',
    ...
    modelsFoundOpeningSelector: 'Found {0} available models. Opening the model list.',
    errorFetchingModels: 'Cannot get language models: {0}',
    errorRefreshingModels: 'Cannot refresh language models: {0}',
    ...
    activationFailed: 'Git Commit Generator did not start. Check the Debug Console.',
